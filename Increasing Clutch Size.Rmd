---
title: "Increasing clutch size and success"
...
success_mod1_b<-glmmTMB(HATCHED ~ 
                      EGGS_UNBURIED+I(EGGS_UNBURIED^2)+ADULTS+as.factor(NEST_ATTMPT)+COMP+(1|SITE:LOCATION)+(1|YEAR),
                      data = ANI, 
                      family=poisson(link="log"))

success_mod2_b<-glmmTMB(FLEDGED ~ 
                      HATCHED+I(HATCHED^2)+ADULTS+as.factor(NEST_ATTMPT)+COMP+(1|SITE:LOCATION)+(1|YEAR),
                      data = ANI, 
                      family=poisson(link="log"))
```
```{r}
summary(success_mod2_b)
```
