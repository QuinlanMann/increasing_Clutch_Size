...
```{r GROUP SIZE}
Tot_mod<-glmmTMB(TOT_EGGS ~ ADULTS+(1|SITE:LOCATION)+(1|YEAR), 
                    data = ANI, 
                    family=poisson(link="log"))

Clutch_mod<-glmmTMB(EGGS_UNBURIED ~ ADULTS+(1|SITE:LOCATION)+(1|YEAR), 
                    data = subset(ANI, EGGS_UNBURIED>0), 
                    family=poisson(link="log"))

Brood_mod<-glmmTMB(HATCHED ~ ADULTS, 
                    data = subset(ANI, HATCHED>0), 
                    family=poisson(link="log"))
...
```{r}
plot(ggpredict(Tot_mod, 
               terms ="ADULTS"))+
  geom_jitter(data=ANI, aes(ADULTS, TOT_EGGS), 
              color="black",
              fill="black",
              stroke=0,
              width=0.15, 
  ...
  labs(x="Adults", y="Total clutch size", title="")+
  theme(
...
```{r}
plot(ggpredict(Clutch_mod, 
               terms ="ADULTS"))+
  geom_jitter(data=subset(ANI, EGGS_UNBURIED>0), aes(ADULTS, EGGS_UNBURIED), 
              color="black",
              fill="black",
              stroke=0,
              width=0.15, 
              ...
              pch=21, 
              size=3)+
  labs(x="Adults", y="Incubated clutch size", title="")+
  theme(
    axis.text = element_text(size=12, color = "black"),
    axis.ticks = element_line(color="black"),
    axis.line.x = element_line(color="black"),
...
```{r}
plot(ggpredict(Brood_mod, 
               terms ="ADULTS"))+
  geom_jitter(data=subset(ANI, HATCHED>0), aes(ADULTS, HATCHED), 
              color="black",
              fill="black",
              stroke=0,
              width=0.15, 
              ...
              pch=21, 
              size=3)+
  labs(x="Adults", y="Brood size", title="")+
  theme(
    axis.text = element_text(size=12, color = "black"),
    axis.ticks = element_line(color="black"),
    axis.line.x = element_line(color="black"),
